...
def audio_callback(indata, frames, time_info, status):
    ...
    if similarity > 0.3:  # Example threshold for NCC
...
while True:
    try: 
        ...
        # input wave
        ref_sample_rate, ref_data = wavfile.read('notify-at-new-lark.wav')
        ...
        music = AudioSegment.from_file("Storm, Earth and Fire.mp3")
