output "network_info" {
  value = module.mkt_eu_networking
}

output "alb_private_dns_1" {
  value = aws_lb.mkt_eu_private.dns_name
}

output "alb_private_dns_2" {
  value = aws_lb.mkt_eu_private2.dns_name
}

output "alb_private_dns_3" {
  value = aws_lb.mkt_eu_private3.dns_name
}
