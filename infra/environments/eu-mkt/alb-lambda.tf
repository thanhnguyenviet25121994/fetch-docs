locals {
  lambda_albs = {
    ...
    #   internal = true
    #   subnets = [
    #     module.mkt_eu_networking.subnet_private_3.id,
    #     module.mkt_eu_networking.subnet_private_4.id
    #   ]
    # }
  }
}
...
resource "aws_lb" "lambda_private" {
  ...
  security_groups    = [module.mkt_eu_networking.vpc.default_security_group_id]
