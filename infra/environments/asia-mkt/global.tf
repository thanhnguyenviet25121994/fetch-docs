module "global_accelerator" {
  ...
  flow_logs_s3_prefix = "mkt-global"
      ...
      endpoint_groups = {
        ap_southeast_1 = {
          ...
          endpoint_configuration = [{
            ...
            endpoint_id                    = aws_lb.mkt_asia.arn
            weight                         = 100
          }]
        }
        eu_west_1 = {
          ...
          endpoint_configuration = [{
            client_ip_preservation_enabled = true
            endpoint_id                    = data.terraform_remote_state.mkt_eu.outputs.alb_arn
            weight                         = 100
          }]
        }
        sa_east_1 = {
          ...
          endpoint_configuration = [{
            client_ip_preservation_enabled = true
            endpoint_id                    = data.terraform_remote_state.mkt.outputs.alb_arn
            weight                         = 100
          }]
        }
      }
...
module "s3_log_bucket" {
  ...
  bucket = "${local.project}-mkt-ga-flowlogs"
