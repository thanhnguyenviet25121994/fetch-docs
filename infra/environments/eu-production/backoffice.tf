...
resource "aws_s3_object" "backoffice_config" {
  ...
  content = <<EOT
window._env_ = {
  __API_BASE_URL__: "https://bo.lnga-rg.com/api"
};
EOT
}
...
module "backoffice_acm" {
  source  = "terraform-aws-modules/acm/aws"
  version = "5.1.1"

  domain_name = aws_s3_bucket.backoffice.bucket
...
module "cloudfront_backoffice" {
  ...
  viewer_certificate = {
    acm_certificate_arn      = module.backoffice_acm.acm_certificate_arn
