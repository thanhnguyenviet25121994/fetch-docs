...
module "prd_eu_lambda_service_logic" {
  ...
  alb_dns_name = aws_lb.prd_eu_private.dns_name
...
module "prd_eu_lambda_service_logic_2" {
  ...
  alb_dns_name = aws_lb.prd_eu_private2.dns_name
...
module "prd_eu_lambda_service_logic_3" {
  ...
  alb_dns_name = aws_lb.prd_eu_private3.dns_name
...
module "prd_eu_lambda_service_logic_4" {
  source  = "../../modules/lambda-service-logic-3-global"
  app_env = local.environment
  ...
  alb_dns_name = aws_lb.prd_eu_private4.dns_name
...
module "prd_eu_lambda_deploy_notify" {
  ...
  ecs_cluster_arn = [
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd-eu-srv-game-client",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd-eu-srv-pp-adaptor",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd-eu-operator-demo",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd-eu-portal-replay",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd-eu-share-ui-game-client",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd-eu-srv-entity",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd_eu-eu-srv-entity",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd_eu-eu-srv-game-client",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd_eu-eu-srv-marketing-2",
    "arn:aws:ecs:eu-west-1:211125478834:cluster/prd_eu-eu-share-ui-game-client",
  ]
}