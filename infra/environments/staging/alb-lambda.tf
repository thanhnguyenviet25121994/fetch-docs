locals {
  lambda_albs = {
    ...
    #   internal = true
    #   subnets = [
    #     module.staging_networking.subnet_private_3.id,
    #     module.staging_networking.subnet_private_4.id
    #   ]
    # }
  }
}
...
resource "aws_lb" "lambda_private" {
  ...
  security_groups    = [module.staging_networking.vpc.default_security_group_id]
