...
module "mkt_lambda_service_logic" {
  ...
  alb_dns_name = aws_lb.mkt_private.dns_name
...
module "mkt_lambda_service_logic_2" {
  ...
  alb_dns_name = aws_lb.mkt_private2.dns_name
...
module "mkt_lambda_service_logic_3" {
  ...
  alb_dns_name = aws_lb.mkt_private3.dns_name
  ...
  services = [
    ...
    {
      name                 = "logic-lucky-clover-lady-clonedpgs"
      env                  = local.default_env_lambda_logic
      handler              = "dist/src/main.handler"
      lambda_architectures = local.default_lambda_architectures
      memory_size          = 256
...
module "mkt_lambda_service_logic_4" {
  source  = "../../modules/lambda-service-logic-3-global"
  app_env = local.environment
  ...
  alb_dns_name = aws_lb.mkt_private4.dns_name
  ...
  services = [
    ...
    {
      name                 = "logic-bigger-bass-blizzard-christmas-vs12bbbxmas-cloned"
      env                  = local.default_env_lambda_logic
      handler              = "dist/src/main.handler"
      lambda_architectures = local.default_lambda_architectures
      memory_size          = 256
