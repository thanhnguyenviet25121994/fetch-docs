output "network_info" {
  value = module.prod_networking
}

output "alb_private_dns_1" {
  value = aws_lb.prod_private.dns_name
}

output "alb_private_dns_2" {
  value = aws_lb.prod_private2.dns_name
}

output "alb_private_dns_3" {
  value = aws_lb.prod_private3.dns_name
}
output "alb_private_dns_4" {
  value = aws_lb.prod_private4.dns_name
}
