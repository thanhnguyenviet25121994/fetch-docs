locals {
  lambda_albs = {
    ...
    #   internal = true
    #   subnets = [
    #     module.prod_networking.subnet_private_3.id,
    #     module.prod_networking.subnet_private_4.id
    #   ]
    # }
  }
}
...
resource "aws_lb" "lambda_private" {
  ...
  security_groups    = [module.prod_networking.vpc.default_security_group_id]
