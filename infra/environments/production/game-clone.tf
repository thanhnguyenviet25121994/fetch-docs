...
module "prod_pp_cloudfront" {
  ...
  origin = {
    s3_prod_pp = {
      ...
      # origin_access_control = "s3_prod_pp"
...
resource "cloudflare_record" "prod_pp" {
  zone_id = data.cloudflare_zone.root.id
  name    = "pp"
  content = module.prod_pp_cloudfront.cloudfront_distribution_domain_name
  type    = "CNAME"
  proxied = false
}