...
module "prod_lambda_service_logic" {
  source  = "../../modules/lambda-service-logic-1-global"
  app_env = local.environment
  ...
  lambda_function_layers = ["arn:aws:lambda:${local.region}:580247275435:layer:LambdaInsightsExtension-Arm64:20"]
  ...
  alb_dns_name = aws_lb.prod_private.dns_name
  ...
  services = {
    ...
    logic-wild-bandito-clonedpgs = {
      env                  = local.default_env_lambda_logic
      handler              = "dist/src/main.handler"
      lambda_architectures = local.default_lambda_architectures
      memory_size          = 256
    }
    logic-midas-fortune-clonedpgs = {
      env                  = local.default_env_lambda_logic
      handler              = "dist/src/main.handler"
      lambda_architectures = local.default_lambda_architectures
      memory_size          = 256
...
module "prod_lambda_service_logic_2" {
  ...
  alb_dns_name = aws_lb.prod_private2.dns_name
  ...
  services = {
    ...
    logic-ganesha-fortune-clonedpgs = {
      env                  = local.default_env_lambda_logic
      handler              = "dist/src/main.handler"
      lambda_architectures = local.default_lambda_architectures
      memory_size          = 256
...
module "prod_lambda_service_logic_3" {
  ...
  alb_dns_name = aws_lb.prod_private3.dns_name
...
module "prod_lambda_service_logic_4" {
  source  = "../../modules/lambda-service-logic-3-global"
  app_env = local.environment
  ...
  alb_dns_name = aws_lb.prod_private4.dns_name
...
module "prod_lambda_deploy_notify" {
  ...
  ecs_cluster_arn = [
    "arn:aws:ecs:sa-east-1:211125478834:cluster/prod-service-game-client",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/prod-service-pp-adaptor",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/prod-operator-demo",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/prod-portal-replay",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/prod-share-ui-game-client",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/prod-service-game-logic",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/prod-service-entity-2",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt-service-entity",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt-service-game-client",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt-service-marketing-2",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt-share-ui-game-client",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt2-service-entity",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt2-service-game-client",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt2-service-marketing-2",
    "arn:aws:ecs:sa-east-1:211125478834:cluster/mkt2-share-ui-game-client"
  ]
}


module "prod_lambda_filter_log_to_lark" {
  ...
  lambda_env = {
    PROD_LARK_WEBHOOK_URL          = "https://open.larksuite.com/open-apis/bot/v2/hook/dd591c97-8aec-4da5-b373-50faa989c9ab"
...
resource "aws_cloudwatch_log_subscription_filter" "sgc_lambda_destination" {
  name            = "ErrorFilter"
  log_group_name  = "prod-service-game-client"
  filter_pattern  = "ERROR -\"o.s.w.reactive.socket.WebSocketHandler\" -\"Session mismatch\" -\"UNKNOWN\" -\"Missing bet setting\" -\"Game not found\""
  destination_arn = module.prod_lambda_filter_log_to_lark.lambda_function_arn
  distribution    = "ByLogStream"
}

module "prod_transfer_wallet_log_to_lark" {
  source = "../../modules/lambda-filter-log-to-lark"

  app_env                   = local.environment
  aws_region                = local.region
  app_name                  = "transfer-wallet-log-to-lark"
  lambda_function_code_path = "../../lambda-function/filter-log-to-lark"
  lambda_env = {
    PROD_LARK_WEBHOOK_URL = "https://open.larksuite.com/open-apis/bot/v2/hook/6a017922-eb8d-47d8-aafa-970bfe821ad1"
  }
}

resource "aws_cloudwatch_log_subscription_filter" "transfer_wallet_lambda_destination" {
  name            = "ErrorFilter"
  log_group_name  = "prod-service-transfer-wallet"
  filter_pattern  = "ERROR"
  destination_arn = module.prod_transfer_wallet_log_to_lark.lambda_function_arn
  distribution    = "ByLogStream"
...
resource "aws_lambda_permission" "allow_cloudwatch_logs" {
  ...
  function_name = "${local.environment}-transfer-wallet-log-to-lark"
  principal     = "logs.amazonaws.com"
  source_arn    = "arn:aws:logs:sa-east-1:211125478834:log-group:prod-service-transfer-wallet:*"
  depends_on    = [module.prod_transfer_wallet_log_to_lark]
}
