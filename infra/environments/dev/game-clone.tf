...
module "dev_pp_cloudfront" {
  ...
  aliases = ["pp.dev.revenge-games.com"]
  ...
  origin = {
    s3_dev_pp = {
      ...
      # origin_access_control = "s3_dev_pp"
...
resource "cloudflare_record" "dev_pp" {
  zone_id = data.cloudflare_zone.root.id
  name    = "pp.dev"
  content = module.dev_pp_cloudfront.cloudfront_distribution_domain_name
  type    = "CNAME"
  proxied = false
}
