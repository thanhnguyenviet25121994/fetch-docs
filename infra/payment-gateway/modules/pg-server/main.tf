...
module "container_definition_service_marketing_2" {
  ...
  secrets = [
    {
      name      = "RG_SIMULATOR_BANK_PROMPTPAYSCAN"
      valueFrom = "${var.secrets.credentials.arn}:RG_SIMULATOR_BANK_PROMPTPAYSCAN::"
    },
    {
      name      = "SPRING_R2DBC_URL"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_URL::"
    },
    {
      name      = "SPRING_R2DBC_USERNAME"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_USERNAME::"
    },
    {
      name      = "SERVER_PORT"
    ...
    },
    {
      ...
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_PASSWORD::"
    },
    {
      name      = "IMAP_MAIL_USERNAME"
      valueFrom = "${var.secrets.credentials.arn}:IMAP_MAIL_USERNAME::"
    },
    {
      name      = "IMAP_MAIL_PASSWORD"
      valueFrom = "${var.secrets.credentials.arn}:IMAP_MAIL_PASSWORD::"
    }
  ]
  log_configuration = {
    logDriver = "awslogs"
...
module "ecs_svc_service_marketing_2" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_marketing_2.container_definition
  }
  cluster_arn      = var.aws_ecs_cluster_arn
  launch_type      = "FARGATE"
  ...
  depends_on = [module.container_definition_service_marketing_2]
}
