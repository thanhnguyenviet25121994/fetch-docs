...
locals {
  ...
  pg_services = {
    pg-server = {
      image                              = "${local.aws_account_id}.dkr.ecr.${local.aws_region}.amazonaws.com/revengegames/pg-server:v1.0.112.1"
      mount_points                       = []
      ...
      secrets = [
        {
          ...
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_server_env.arn}:SPRING_R2DBC_URL::"
        },
        {
          name      = "SPRING_R2DBC_USERNAME"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_server_env.arn}:SPRING_R2DBC_USERNAME::"
        },
        {
          name      = "SERVER_PORT"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_server_env.arn}:SERVER_PORT::"
        },
        {
          name      = "SPRING_R2DBC_PASSWORD"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_server_env.arn}:SPRING_R2DBC_PASSWORD::"
        },
        {
          name      = "SPRING_FLYWAY_URL"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_server_env.arn}:SPRING_FLYWAY_URL::"
        },
        {
          name      = "SPRING_FLYWAY_USER"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_server_env.arn}:SPRING_FLYWAY_USER::"
        },
        {
          name      = "SPRING_FLYWAY_PASSWORD"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_server_env.arn}:SPRING_FLYWAY_PASSWORD::"
        }
      ]
      ...
      conditions = [{
        host_header = {
          values = ["payment.sandbox.revenge-games.com"]
        },
        path_pattern = {
          values = ["/*"]
        }
    ...
    pg-demo-merchant-server = {
      image                              = "${local.aws_account_id}.dkr.ecr.${local.aws_region}.amazonaws.com/revengegames/pg-demo-merchant-server:v1.0.12.1"
      mount_points                       = []
      healthcheck_path                   = "/actuator/health"
      alb_disable                        = false
      volume                             = []
      ...
      environment = [
        ...
        },
        {
          ...
          value = "https://payment.sandbox.revenge-games.com/payment-checkout"
        }
      ]
      secrets = [
        {
          name      = "SPRING_R2DBC_URL"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_demo_merchant_server_env.arn}:SPRING_R2DBC_URL::"
        },
        {
          name      = "SPRING_R2DBC_USERNAME"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_demo_merchant_server_env.arn}:SPRING_R2DBC_USERNAME::"
        },
        {
          name      = "SERVER_PORT"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_demo_merchant_server_env.arn}:SERVER_PORT::"
        },
        {
          name      = "SPRING_R2DBC_PASSWORD"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_demo_merchant_server_env.arn}:SPRING_R2DBC_PASSWORD::"
        },
        {
          name      = "RG_BASEURL"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_demo_merchant_server_env.arn}:RG_BASEURL::"
        },
        {
          name      = "RG_CODE"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_demo_merchant_server_env.arn}:RG_CODE::"
        },
        {
          name      = "RG_SECRET"
          valueFrom = "${data.aws_secretsmanager_secret.sandbox_pg_demo_merchant_server_env.arn}:RG_SECRET::"
        }
      ]
      enable_autoscaling       = true
      autoscaling_min_capacity = 1
      ...
      conditions = [{
        host_header = {
          values = ["demo-merchant.sandbox.revenge-games.com"]
        },
        path_pattern = {
          values = ["/*"]
        }
