      ...
      secrets = [
        {
          ...
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_server_env.arn}:SPRING_R2DBC_URL::"
        },
        {
          name      = "SPRING_R2DBC_USERNAME"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_server_env.arn}:SPRING_R2DBC_USERNAME::"
        },
        {
          name      = "SERVER_PORT"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_server_env.arn}:SERVER_PORT::"
        },
        {
          name      = "SPRING_R2DBC_PASSWORD"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_server_env.arn}:SPRING_R2DBC_PASSWORD::"
        },
        {
          name      = "SPRING_FLYWAY_URL"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_server_env.arn}:SPRING_FLYWAY_URL::"
        },
        {
          name      = "SPRING_FLYWAY_USER"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_server_env.arn}:SPRING_FLYWAY_USER::"
        },
        {
          name      = "SPRING_FLYWAY_PASSWORD"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_server_env.arn}:SPRING_FLYWAY_PASSWORD::"
        }
      ]
    ...
    pg-demo-merchant-server = {
      ...
      environment = [
        ...
        },
        {
          ...
          value = "https://revenge-pay.com/payment-checkout"
        }
      ]
      secrets = [
        {
          name      = "SPRING_R2DBC_URL"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_demo_merchant_server_env.arn}:SPRING_R2DBC_URL::"
        },
        {
          name      = "SPRING_R2DBC_USERNAME"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_demo_merchant_server_env.arn}:SPRING_R2DBC_USERNAME::"
        },
        {
          name      = "SERVER_PORT"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_demo_merchant_server_env.arn}:SERVER_PORT::"
        },
        {
          name      = "SPRING_R2DBC_PASSWORD"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_demo_merchant_server_env.arn}:SPRING_R2DBC_PASSWORD::"
        },
        {
          name      = "RG_BASEURL"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_demo_merchant_server_env.arn}:RG_BASEURL::"
        },
        {
          name      = "RG_CODE"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_demo_merchant_server_env.arn}:RG_CODE::"
        },
        {
          name      = "RG_SECRET"
          valueFrom = "${data.aws_secretsmanager_secret.prod_pg_demo_merchant_server_env.arn}:RG_SECRET::"
        }
      ]
      enable_autoscaling       = true
      autoscaling_min_capacity = 1
      ...
      conditions = [{
        host_header = {
          values = ["merchant.revenge-pay.com"]
        },
        path_pattern = {
          values = ["/*"]
        }
