...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_definition_service_pp_adaptor"></a> [container\_definition\_service\_pp\_adaptor](#module\_container\_definition\_service\_pp\_adaptor) | ../task-definition | n/a |
| <a name="module_ecs_svc_service_pp_adaptor"></a> [ecs\_svc\_service\_pp\_adaptor](#module\_ecs\_svc\_service\_pp\_adaptor) | terraform-aws-modules/ecs/aws//modules/service | v5.11.2 |
...
| <a name="input_app_name"></a> [app\_name](#input\_app\_name) | n/a | `string` | `"service-pp-adaptor"` | no |
