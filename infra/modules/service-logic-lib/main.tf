...
module "container_definition_service_logic_rtp" {
...
module "ecs_svc_service_logic_rtp" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_logic_rtp.container_definition
  }
  ...
  depends_on = [module.container_definition_service_logic_rtp]
}
