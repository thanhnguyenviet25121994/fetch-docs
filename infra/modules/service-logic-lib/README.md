...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_definition_service_logic_rtp"></a> [container\_definition\_service\_logic\_rtp](#module\_container\_definition\_service\_logic\_rtp) | ../task-definition | n/a |
| <a name="module_ecs_svc_service_logic_rtp"></a> [ecs\_svc\_service\_logic\_rtp](#module\_ecs\_svc\_service\_logic\_rtp) | terraform-aws-modules/ecs/aws//modules/service | v5.11.2 |
...
| <a name="input_task_size_cpu"></a> [task\_size\_cpu](#input\_task\_size\_cpu) | n/a | `number` | `256` | no |
| <a name="input_task_size_memory"></a> [task\_size\_memory](#input\_task\_size\_memory) | n/a | `number` | `512` | no |
