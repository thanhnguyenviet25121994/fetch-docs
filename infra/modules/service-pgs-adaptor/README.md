...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_definition_service_pgs_adaptor"></a> [container\_definition\_service\_pgs\_adaptor](#module\_container\_definition\_service\_pgs\_adaptor) | ../task-definition | n/a |
| <a name="module_ecs_svc_service_pgs_adaptor"></a> [ecs\_svc\_service\_pgs\_adaptor](#module\_ecs\_svc\_service\_pgs\_adaptor) | terraform-aws-modules/ecs/aws//modules/service | v5.11.2 |
...
| <a name="input_app_name"></a> [app\_name](#input\_app\_name) | n/a | `string` | `"service-pgs-adaptor"` | no |
