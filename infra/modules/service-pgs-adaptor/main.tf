...
module "container_definition_service_pgs_adaptor" {
...
module "ecs_svc_service_pgs_adaptor" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_pgs_adaptor.container_definition
  }
  ...
  depends_on = [module.container_definition_service_pgs_adaptor]
}
