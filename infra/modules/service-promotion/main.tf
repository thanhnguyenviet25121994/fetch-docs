...
module "container_definition_service_promotion" {
  ...
  secrets = [
    {
      name      = "SPRING_R2DBC_WRITE_URL"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_WRITE_URL::"
    },
    {
      name      = "SPRING_R2DBC_WRITE_USERNAME"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_WRITE_USERNAME::"
    },
    {
      name      = "SPRING_R2DBC_WRITE_PASSWORD"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_WRITE_PASSWORD::"
    },
    {
      name      = "SPRING_R2DBC_READ_URL"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_READ_URL::"
    },
    {
      name      = "SPRING_R2DBC_READ_USERNAME"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_READ_USERNAME::"
    },
    {
      name      = "SPRING_R2DBC_READ_PASSWORD"
      valueFrom = "${var.secrets.credentials.arn}:SPRING_R2DBC_READ_PASSWORD::"
    },
    {
    ...
    },
    {
      ...
      valueFrom = "${var.secrets.credentials.arn}:SPRING_FLYWAY_URL::"
    },
  ]
  log_configuration = {
    logDriver = "awslogs"
...
module "ecs_svc_service_promotion" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_promotion.container_definition
  }
  ...
  depends_on = [module.container_definition_service_promotion]
}
