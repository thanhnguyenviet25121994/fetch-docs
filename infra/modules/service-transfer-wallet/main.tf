...
variable "app_name" {
  type    = string
  default = "service-transfer-wallet"
}
...
module "container_definition_service_transfer_wallet" {
...
module "ecs_service_transfer_wallet" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_transfer_wallet.container_definition
  }
  ...
  depends_on = [module.container_definition_service_transfer_wallet]
}
