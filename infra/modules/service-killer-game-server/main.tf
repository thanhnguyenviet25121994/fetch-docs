...
variable "app_name" {
  type    = string
  default = "service-killer-game-server"
}
...
module "container_definition_service_killer_game_server" {
...
module "ecs_service_killer_game_server" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_killer_game_server.container_definition
  }
  ...
  depends_on = [module.container_definition_service_killer_game_server]
}
