...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_definition_service_transfer_wallet"></a> [container\_definition\_service\_transfer\_wallet](#module\_container\_definition\_service\_transfer\_wallet) | ../task-definition | n/a |
| <a name="module_ecs_service_transfer_wallet"></a> [ecs\_service\_transfer\_wallet](#module\_ecs\_service\_transfer\_wallet) | terraform-aws-modules/ecs/aws//modules/service | v5.11.2 |
...
| <a name="input_app_name"></a> [app\_name](#input\_app\_name) | n/a | `string` | `"service-transfer-wallet"` | no |
| <a name="input_env"></a> [env](#input\_env) | n/a | `map(string)` | `{}` | no |
| <a name="input_image"></a> [image](#input\_image) | n/a | `string` | n/a | yes |
| <a name="input_instance_count_max"></a> [instance\_count\_max](#input\_instance\_count\_max) | n/a | `number` | `16` | no |
