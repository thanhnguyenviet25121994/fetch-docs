...
variable "app_name" {
  type    = string
  default = "service-hacksaw-adaptor"
}
...
module "container_definition_service_hacksaw_adaptor" {
...
module "ecs_svc_service_hacksaw_adaptor" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_hacksaw_adaptor.container_definition
  }
  ...
  depends_on = [module.container_definition_service_hacksaw_adaptor]
}
