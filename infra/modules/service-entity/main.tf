...
module "container_definitions" {
  ...
  environment = [{
    ...
    name  = "JAVA_OPTS"
    value = "-Dcom.linecorp.armeria.verboseResponses=true"
  }]
  secrets = [{
    ...
    {
      name      = "SPRING_DATASOURCE_READ_HOST",
      valueFrom = "${var.db.credentials.arn}:SPRING_DATASOURCE_READ_HOST::"
    },

    {
      name      = "SPRING_DATASOURCE_WRITE_HOST",
      valueFrom = "${var.db.credentials.arn}:SPRING_DATASOURCE_WRITE_HOST::"
    },
    {
      name      = "SPRING_DATASOURCE_READ_USERNAME",
      valueFrom = "${var.db.credentials.arn}:username::"
    },
    {
      ...
      services = [
        {
          ...
          port_name      = "${var.app_name}-grpc"
          discovery_name = "${var.app_name}-grpc"
