resource "aws_s3_bucket" "this" {
  bucket = "lobby.${var.app_env}.${var.domain}"

  tags = {
    Name        = "lobby.${var.app_env}.${var.domain}"
...
module "cloudfront" {
  ...
  aliases = ["lobby.${var.app_env}.${var.domain}"]

  comment             = "${var.app_env} Cloufront for lobby ${var.domain}"
  enabled             = true
  ...
  ordered_cache_behavior = [
    {
      ...
      origin_request_policy_name = "Managed-AllViewer" # "AllViewerAndCloudFrontHeaders-2022-06"
    }
  ]
