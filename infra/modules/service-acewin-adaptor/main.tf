...
variable "app_name" {
  type    = string
  default = "service-acewin-adaptor"
}
...
module "container_definition_service_acewin_adaptor" {
...
module "ecs_svc_service_acewin_adaptor" {
  ...
  container_definitions = {
    (var.app_name) = module.container_definition_service_acewin_adaptor.container_definition
  }
  ...
  depends_on = [module.container_definition_service_acewin_adaptor]
}
